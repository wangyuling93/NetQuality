...
echo "bash <(curl -sL https://cdn.jsdelivr.net/gh/wangyuling93/NetQuality@main/ref/upgrade_bash.sh)"
exit 0
fi
}
check_bash
...
rawgithub="https://github.com/wangyuling93/NetQuality/raw/"
return 0
else
rawgithub="https://cdn.jsdelivr.net/gh/wangyuling93/NetQuality@"
return 1
fi
}
is_valid_ipv4(){
...
rdomain[10]="hn-ct-v$ipv.ip.zstaticcdn.com"
rdomain[11]="hn-cu-v$ipv.ip.zstaticcdn.com"
rdomain[12]="hn-cm-v$ipv.ip.zstaticcdn.com"
